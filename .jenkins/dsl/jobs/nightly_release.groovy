...
// Deploy pipeline
KogitoJobTemplate.createPipelineJob(this, getJobParams('kogito-examples-deploy', 'Kogito Examples Deploy', 'Jenkinsfile.deploy')).with {
    parameters {
    ...
    environmentVariables {
        ...
        env('MAVEN_REPO_CREDS_ID', "${MAVEN_REPO_CREDS_ID}")
...
// Promote pipeline
KogitoJobTemplate.createPipelineJob(this, getJobParams('kogito-examples-promote', 'Kogito Examples Promote', 'Jenkinsfile.promote')).with {
    parameters {
        stringParam('DISPLAY_NAME', '', 'Setup a specific build display name')
